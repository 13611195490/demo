<template>
  <el-dialog :title="title" :visible.sync="visible" v-on:close="close">
    <el-form :model="form" ref="form" label-width="120px">
      <el-form-item label="文件名称" prop="IndexItemID" :rules="formRuleRequired('文件名称ID不能为空')">
        <el-input type="text" placeholder="请输入" v-model="form.IndexItemID" autocomplete="off" ></el-input>
      </el-form-item>
      ...
      <el-form-item label="文件列表" prop="pictureFile">
        <div>
