  ...
  <el-dialog :title="title" :visible.sync="visible" v-on:close="close">
    <el-form :model="form" ref="form" label-width="120px">
      ...
      <el-form-item label="时间" prop="year" :rules="formRuleRequired('时间不能为空')">
        <el-date-picker v-model="form.year" :picker-options="pickerOptions" value-format="yyyy-MM-dd" format="yyyy-MM-dd " type="date" placeholder="请输入" :disabled="editType==='update'"></el-date-picker>
      </el-form-item>
      <el-form-item label="小时计数" prop="hourIndex" :rules="formRuleRequired('小时计数不能为空')">
        <el-input type="text" placeholder="请输入" v-model="form.hourIndex" autocomplete="off" :disabled="editType==='update'"></el-input>
      </el-form-item>
