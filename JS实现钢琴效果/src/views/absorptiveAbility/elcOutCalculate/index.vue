  ...
  <div id="content">
    <div class="rate clearfix">
      <el-breadcrumb separator=" > " class="breadcrumb">
        ...
        <el-breadcrumb-item>发电预测</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ name: 'elcOutCalculate' }"><b>发电预测计算</b></el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="elcOutCalculate">
      <el-row class="chart">
        <h3 class="header-label">发电计算</h3>
        ...
        <elc-out-predict v-if="detailShow" @hidePopup="hidePopup" ref="detailShow"></elc-out-predict>
      </el-row>
    </div>
  </div>
</template>
...
import ElcOutPredict from './elcOutPredict'
export default {
